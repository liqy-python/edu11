            ...
            <div class="course-content">
                <div class="course-tab-list">
                    <div class="tab-item" v-if="tabIndex==1">
                        <div v-html="detail.brief_html"></div>
                    </div>
                    ...
                    <div class="teacher-info">
                        ...
                        <div class="teacher-content">
                            <div class="cont1">
                                ...
                                <div class="name">
                                    <p class="teacher-name">{{detail.teacher.name}}</p>
                                    <p class="teacher-title">{{detail.teacher.signature}}</p>
                                </div>
                            </div>
                            <p class="narrative">{{detail.teacher.brief}}</p>
                        </div>
                    </div>
                </div>
            </div>
