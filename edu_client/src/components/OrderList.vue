                ...
                <div class="my-order-item">
                    ...
                    <ul class="nav user-data-list">
                        <li class="order-info">
                            <img src="../../static/image/logo@2x.png" alt="">
                            <div class="order-info-title">
                                <p class="course-title">DRF进阶课程</p>
                                <p class="price-service">限时减免</p>
                            </div>
                        </li>
                        <li class="course-expire">永久有效</li>
                        <li class="course-price">299.00</li>
                        <li class="real-price">188.00</li>
                        <li class="order-status">30分53s</li>
                        <li class="order-do">
                            <span class="btn btn2">去支付</span>
                        </li>
                    </ul>
                     ...
                     <ul class="nav user-data-list">
                        ...
                        <li class="course-price">299.00</li>
                        <li class="real-price">188.00</li>
                        <li class="order-status">已取消</li>
                        <li class="order-do">
                            <span class="btn btn2">重新下单</span>
                        </li>
                    </ul>
